...
*/
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					teks = body.slice(7)
					reply('「❗」WAIT KAK GUE NULIS DULU YAKAN')
...
*/
           ...
           if (!isRegistered) return reply(ind.noregis())
					apakah = body.slice(1)
					const apa = fs.readFileSync('./manca/iya.mp3','./mancabot/mungkin iya.mp3','./mancabot/mungkin tidak.mp3','./mancabot/tidak.mp3','./mancabot/ferguso.mp3','./mancabot/iya.mp3);
...
*/		 
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))				
					...
					try {
						...
						console.log('Error :', e)
						reply('astaghfirullah yang mau di add di private, dahlah :)')
					}
					break
			     	case 'kick':
                  if (isBanned) return reply(ind.baned())
...
break
case 'manca':
manca = fs.readFileSync('./assets/manca.mp3');
client.sendMessage(from, manca, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'slow':
date = fs.readFileSync('./assets/playdate.mp3');
client.sendMessage(from, date, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'terpesona':
sona = fs.readFileSync('./assets/terpesona.mp3');
client.sendMessage(from, sona, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'lolican':
lolican= fs.readFileSync('./assets/lolican.mp3');
client.sendMessage(from, lolican, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'onichan':
onichan= fs.readFileSync('./assets/onichan.mp3');
client.sendMessage(from, onichan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bot':
nani= fs.readFileSync('./assets/nani.mp3');
client.sendMessage(from, nani, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'jamet':
jamet= fs.readFileSync('./assets/jamet.mp3');
client.sendMessage(from, jamet, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'araara':
ara= fs.readFileSync('./assets/araara.mp3');
client.sendMessage(from, ara, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'iklan':
iklan= fs.readFileSync('./assets/iklan.mp3');
client.sendMessage(from, iklan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'iklan1':
lan= fs.readFileSync('./assets/sariroti.mp3');
client.sendMessage(from, lan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break														
/*
]=====> TQTO <=====[
> RAMLAN ID
